    ...
    return (
        <div className="min-h-[15%] bg-teal-900 text-white p-10 pl-20 pr-20 text-justify">
            ...
            <p className="pt-10 w-[50%] text-center m-auto">
                <span className="text-blue-300 font-bold  ">All in one</span> application samples are available here.
                Where all cms project all together in single place. Almost responsive code. With nice color choice.
            </p>
